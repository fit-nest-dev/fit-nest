 ...
 */
const SuccessPageMembershipBuy = () => {
      ...
      >
        ...
        >
          <p style={{ color: '#FFFFFF', fontWeight: 'bold', marginBottom: '10px' }}>
            Name: <span style={{ color: '#66FF66' }}>{!userDetails ? "" : userDetails?.first_name + " " + userDetails?.last_name}</span>
          </p>
          <p style={{ color: '#FFFFFF', fontWeight: 'bold', marginBottom: '10px' }}>
...
export default SuccessPageMembershipBuy;
